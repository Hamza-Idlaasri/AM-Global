...
class SwitchDB extends Controller
{
    ...
    public function switchDB($id,$db_host,$db_port,$db_database,$db_username,$db_password)
    {

        $envFile = app()->environmentFilePath();
        $str = file_get_contents($envFile);

        $old_DB_CONNECTION = env('SITE_ID');
        ...
        $str = str_replace("SITE_ID={$old_DB_CONNECTION}", "SITE_ID={$id}", $str);
